  ...
  return (
    <header className="sticky-top p-2">
      <nav className={`border border-1 border-secondary rounded-pill shadow-sm navbar navbar-expand-sm ${navbarTheme} bg-${theme}-blur`}>
        <div className="container-fluid">
          ...
          <div className="d-flex justify-content-end">
            ...
            <button onClick={toggleTheme} className={`themeToggle d-flex ms-2 justify-content-center align-items-center rounded-pill btn btn-${inverseTheme}`} title={theme === "light" ? "Switch to Dark Mode" : "Switch to Light Mode"}>
              <span className="material-symbols-rounded">
            ...
            <button
              ...
              className={`menuToggle d-flex ms-2 d-md-none justify-content-center align-items-center rounded-pill btn btn-outline-${inverseTheme}`}
      ...
      <div className={`offcanvas offcanvas-end bg-${theme} text-${inverseTheme}`} id="favourites">
        ...
        {/* DELETE DROP ZONE */}
          <div
            className={`bg-${theme} sticky-top fav-delete-zone m-3 d-flex justify-content-center align-items-center`}
